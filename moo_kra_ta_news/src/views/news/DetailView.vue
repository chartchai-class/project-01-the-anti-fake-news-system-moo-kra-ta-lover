...
<template>
    ...
    <div v-if="news">
        ...
        <div class="flex items-center gap-2 font-inter my-6">
            <div class="rounded-full w-8 h-8 bg-indigo-500 flex items-center justify-center text-xl text-white">{{ news.reporter.charAt(0).toUpperCase() }}</div>
