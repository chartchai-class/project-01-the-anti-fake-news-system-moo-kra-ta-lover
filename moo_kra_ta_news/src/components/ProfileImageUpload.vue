        ...
        <div v-else class="image-preview">
            <div class="bg-green-50 border border-green-200 rounded-2xl p-6">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-green-700 text-sm">Your Profile picture has been uploaded successfully</p>
                        </div>
                    </div>
                    <!-- <button 
                        type="button" 
                ...
                <div class="flex items-center gap-4 bg-white rounded-xl p-4 border border-green-100">
                    ...
                    />
                    <div class="flex-1">
                        <p class="text-gray-900 font-medium text-sm mb-1">Your profile picture</p>
                        <p class="text-gray-500 text-xs">This image will appear when you vote/comments</p>
                    </div>
                    <button 
                        type="button" 
                        @click="clearImage" 
